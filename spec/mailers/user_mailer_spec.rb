...
#
# Weegid CRM is freely distributable under the terms of MIT license.
...
describe UserMailer do
  describe "password_reset_instructions" do
    ...
    it "sets the subject" do
      expect(mail.subject).to eq("Weegid CRM: Password Reset Instructions")
    end
  ...
  describe "assigned_entity_notification" do
    ...
    context "for an account" do
      ...
      it "sets the subject" do
        expect(mail.subject).to eq("Weegid CRM: You have been assigned Ghostbusters Account")
      end
    ...
    context "for a contact" do
      ...
      it "sets the subject" do
        expect(mail.subject).to eq("Weegid CRM: You have been assigned Harold Ramis Contact")
      end
    ...
    context "for a lead" do
      ...
      it "sets the subject" do
        expect(mail.subject).to eq("Weegid CRM: You have been assigned Bill Murray Lead")
      end
    ...
    context "for an opportunity" do
      ...
      it "sets the subject" do
        expect(mail.subject).to eq("Weegid CRM: You have been assigned Big Opportunity")
      end
