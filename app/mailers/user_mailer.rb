...
class UserMailer < ActionMailer::Base
  def password_reset_instructions(user)
    ...
    mail subject: "Weegid CRM: " + I18n.t(:password_reset_instruction),
         to: user.email,
         from: from_address,
         date: Time.now
  end
  ...
  def assigned_entity_notification(entity, assigner)
    ...
    mail subject: "Weegid CRM: You have been assigned #{@entity_name} #{@entity_type}",
  ...
  def from_address
    ...
    !from.blank? ? from : "Weegid CRM <noreply@weegidcrm.com>"
  end
end
